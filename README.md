...
[![OpenReward Environment](https://img.shields.io/badge/%E2%AD%90%20OpenReward-Environment-f7e6cc)](https://openreward.ai/YourOrg/zebra)
...
@dataset{YourCitation,
  ...
  url       = {https://openreward.ai/YourOrg/zebra}
}
```
